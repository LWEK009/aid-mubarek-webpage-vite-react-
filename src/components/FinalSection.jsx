  ...
  return (
    ...
    >
      <div className="text-center max-w-xl mx-auto">
        ...
        {/* Final Promise */}
        <div
          className={`mt-20 mb-8 transition-all duration-1000 ${
            isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
          }`}
          style={{ transitionDelay: '1200ms' }}
        >
          <h2 className="font-[Aref_Ruqaa] font-bold text-3xl md:text-5xl text-gold-100 drop-shadow-[0_0_15px_rgba(255,215,0,0.5)]">
            بيني وبينكِ عهدٌ ان لانكونَ لغيرنا ابداً
          </h2>
        </div>
      </div>
    </section>
